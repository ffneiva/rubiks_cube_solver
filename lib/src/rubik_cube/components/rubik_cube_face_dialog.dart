...
class RubikCubeFaceDialog extends StatefulWidget {
  final RubikCubeController rubikCubeController;
  final int face;

  const RubikCubeFaceDialog({
    Key? key,
  ...
  @override
  State<RubikCubeFaceDialog> createState() => _RubikCubeFaceDialogState();
}

class _RubikCubeFaceDialogState extends State<RubikCubeFaceDialog> {
